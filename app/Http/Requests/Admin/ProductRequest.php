...
class ProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'price_groothandel' => ['required', 'numeric', 'min:0', 'max:999999.99'],
            'price_broodjeszaak' => ['required', 'numeric', 'min:0', 'max:999999.99'],
            'price_horeca' => ['required', 'numeric', 'min:0', 'max:999999.99'],
    ...
    public function attributes(): array
    {
        return [
            ...
            'title' => 'naam',
            'photo' => 'foto',
            'price_groothandel' => 'prijs groothandel',
            'price_broodjeszaak' => 'prijs broodjeszaak',
            'price_horeca' => 'prijs horeca',
